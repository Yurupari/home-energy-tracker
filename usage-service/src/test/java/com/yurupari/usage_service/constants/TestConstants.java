package com.yurupari.usage_service.constants;

public class TestConstants {

    public static final String ENERGY_USAGE_EVENT_JSON = "model/event/energy_usage_event.json";
    public static final String DEVICE_DTO_JSON = "model/dto/device_dto.json";
